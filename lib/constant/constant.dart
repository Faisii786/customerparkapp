...
class Constant {
  ...
  static const String roleType = "customerparkapp";

  static String mapAPIKey = "AIzaSyBT37okQDv2VbCKn76sxFaMQROGgNC3WRg";
  static String senderId = '';
  static String jsonNotificationFileURL = '';
  static String radius = "4000";
